...
// Geometry
const geometry = new THREE.PlaneGeometry(10, 8, 512, 512);
...
const material = new THREE.ShaderMaterial({
  ...
  uniforms: {
    uWaveLength: { value: 0.149 },
    uFrequency: { value: new THREE.Vector2(2.832, 2.832) },
    uTime: { value: 0 },
...
camera.position.set(0.0, 0.7, 0.0);
scene.add(camera);
...
const animate = () => {
  ...
  camera.lookAt(Math.cos(elapsedTime) * 0.1, Math.sin(elapsedTime) * 0.1);
